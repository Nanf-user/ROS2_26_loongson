...
sleep 2
# SLAM建图
gnome-terminal -- bash -c "$SRC_CMD && ros2 launch e05_slam_toolbox_mapping slam_toolbox_launch.py; exec bash"
sleep 1
# 键盘遥控
gnome-terminal -- bash -c "$SRC_CMD && ros2 run teleop_twist_keyboard teleop_twist_keyboard; exec bash"
