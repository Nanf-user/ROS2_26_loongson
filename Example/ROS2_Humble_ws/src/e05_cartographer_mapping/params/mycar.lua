...
options = {
  ...
  rangefinder_sampling_ratio = 1.0, -- 雷达采样比例
...
TRAJECTORY_BUILDER_2D.max_range = 3.0 -- 最大雷达有效距离
...
TRAJECTORY_BUILDER_2D.motion_filter.max_angle_radians = math.rad(0.01) -- 运动滤波器的最大角度限制（以弧度为单位）
